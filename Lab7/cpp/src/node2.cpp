...
public:
    ...
    {
        string_subscriber_ = this->create_subscription<std_msgs::msg::String>("name",rclcpp::SensorDataQoS(), std::bind(&Node2::timer_cb, this, std::placeholders::_1));
        
    }
private:
    void timer_cb(const std_msgs::msg::String::SharedPtr msg)const
    {
        RCLCPP_INFO(this->get_logger(),"I heard your name  '%s' ",msg->data.c_str());
    }
